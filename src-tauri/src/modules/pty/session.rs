...
const AGENT_EVENT: &str = "arnavterminal:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[arnavterminal: dropped output due to backpressure]\x1b[0m\r\n";
...
pub fn spawn(
    ...
    let reader_thread = thread::Builder::new()
        .name("arnavterminal-pty-reader".into())
        .spawn(move || {
    ...
    thread::Builder::new()
        .name("arnavterminal-pty-flusher".into())
        .spawn(move || {
    ...
    let done_e = done;
    thread::Builder::new()
        .name("arnavterminal-pty-waiter".into())
        .spawn(move || {
