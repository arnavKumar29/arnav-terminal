...
export const DEFAULT_THEME_ID = "arnavterminal-default";
...
const STORE_PATH = "arnavterminal-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "arnavterminal://prefs-changed";
...
const KEYS_CHANGED_EVENT = "arnavterminal://ai-keys-changed";
