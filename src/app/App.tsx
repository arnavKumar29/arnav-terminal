...
const SIDEBAR_WIDTH_STORAGE_KEY = "arnavterminal.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "arnavterminal.sidebar.view";
      ...
      (event) => {
        ...
        void (async () => {
          try {
            ...
            if (!parsed.ok) {
              console.warn("[arnavterminal] theme not applied:", parsed.error);
              return;
            }
            await saveCustomTheme(parsed.theme);
          } catch (e) {
            console.warn("[arnavterminal] theme ingest failed:", e);
          }
        })();
      },
    );
  ...
  const handleAttachFileToAgent = useCallback(
    (path: string) => {
      ...
      window.dispatchEvent(
        new CustomEvent<string>("arnavterminal:ai-attach-file", { detail: path }),
      );
      openPanel();
      focusInput(null);
    },
        ...
        <div className="relative flex h-screen flex-col overflow-hidden bg-background text-foreground">
          ...
          <main className="zoom-content flex min-h-0 flex-1 flex-col">
            <ResizablePanelGroup
              ...
              className="min-h-0 flex-1 p-2 gap-2"
            >
              <ResizablePanel id="workspace" defaultSize="78%" minSize="30%">
                <div className="flex h-full min-h-0 flex-col rounded-xl overflow-hidden border border-border/40 shadow-xl bg-background/80 backdrop-blur-sm">
              ...
              >
                <div className="flex h-full min-h-0 flex-col rounded-xl border border-border/40 shadow-lg bg-card/80 backdrop-blur-md overflow-hidden">
